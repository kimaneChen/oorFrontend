...
export default function CompleteTaskModal({ reviewOffer, onClose }) {
  return (
    <>
      <CancelContent>
        <CancelInfo>
          <DetailedInfo>
            <ContentInfo>
              Are you satisfied with this tasker service?
              <br />
              Please Score this service.
            </ContentInfo>
          </DetailedInfo>
        </CancelInfo>
      </CancelContent>
      <CancelFooter>
        <CancelButtonGroup>
          ...
          <CancelButtonRight>
            <Button variant="red" onClick={reviewOffer}>
              Submit The Result
            </Button>
          </CancelButtonRight>
        </CancelButtonGroup>
