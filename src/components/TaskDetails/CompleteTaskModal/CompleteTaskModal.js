...
export default function CompleteTaskModal({ completeTask, onClose }) {
  return (
    <>
      <CancelContent>
        <CancelInfo>
          <DetailedInfo>
            <ContentInfo>Do you complete the task and apply for payment?</ContentInfo>
          </DetailedInfo>
        </CancelInfo>
      </CancelContent>
      <CancelFooter>
        <CancelButtonGroup>
          ...
          <CancelButtonRight>
            <Button variant="red" onClick={completeTask}>
              Complete This Task
            </Button>
          </CancelButtonRight>
        </CancelButtonGroup>
